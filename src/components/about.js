                ...
                <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto py-32 lg:my-0">
                    ...
                    <div id="profile"
                        ...
                        <div className="p-4 md:p-12 text-center lg:text-left">
                            ...
                            <p className="pt-8 text-sm">As a 20-year-old student of Košice Academy of Software Development (KASV), I have a deep passion for working in the field of Information Technology. I particularly enjoy the creative aspects of web design and the challenges posed by both front-end and back-end development. Continuously learning and embracing new concepts is a fundamental part of my journey as I strive to excel in various facets of IT.</p>
