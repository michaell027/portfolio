    ...
    <>
      ...
      >
        <div className="flex w-full flex-col items-center lg:mx-auto h-full justify-center">
          <div
            className="flex flex-col w-5/6 xl:w-2/3 bg-gray-500/30 mt-16 xl:mt-28 hover:scale-110 duration-1000 transform ease-in-out cursor-pointer rounded-xl"
          ...
          <div className="mt-6 mb-6 flex flex-col items-center justify-center text-white w-1/3 text-center text-[16px]">
            <p className="mb-4">
