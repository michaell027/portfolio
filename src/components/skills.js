...
export default function Skills() {
  return (
    <div
      className="leading-normal tracking-normal text-black bg-cover min-h-screen flex flex-wrap items-center justify-center bg-center bg-no-repeat"
      style={{ backgroundImage: "url('header.png')" }}
    >
      <div className="mockup-window mx-auto mt-16 mb-16 xl:mb-0 xl:mt-0 h-fit lg:w-4/5 xl:mx-60 md:w-11/12 bg-gray-500/40">
        <h2 className="text-5xl text-center text-white font-extrabold">
          What I do:
        </h2>
        <p className="text-center mt-2 mb-4 mx-8 text-white text-sm sm:text-md lg:text-[16px] font-light">
          I am always on the lookout for ways to improve my skills and grow
          professionally. I embrace new learning opportunities and am committed
          to staying updated in my field.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 sm:grid-cols-3 lg:grid-cols-5 gap-8 mx-8 mb-12">
            ...
            <div className="w-28 h-28 p-2 shadow-xl shadow-black transform duration-300 hover:scale-110 ease-in-out">
              <div className="flex justify-center flex-col items-center">
                <img
                  ...
                  alt="html"
                />
                <h5 className="text-center text-lg text-white font-bold">
                  HTML
                </h5>
              </div>
            </div>
          ...
          <div className="w-full flex justify-center items-center">
            <div className="w-28 h-28 p-2 shadow-xl shadow-black transform duration-300 hover:scale-110 ease-in-out">
              <div className="flex justify-center flex-col items-center">
                <img
                  src="https://img.icons8.com/color/96/000000/microsoft-office-2019"
                  className="w-16 h-16"
                  alt="office"
                />
                <h5 className="text-center text-white text-lg font-bold">
          ...
          <div className="w-full flex justify-center items-center">
            <div className="w-28 h-28 p-2 shadow-xl shadow-black transform duration-300 hover:scale-110 ease-in-out">
              <div className="flex justify-center flex-col items-center">
                <img
                  src="https://img.icons8.com/color/96/000000/filmora.png"
                  className="w-16 h-16"
                  alt="filmora"
                />
                <h5 className="text-center text-white text-lg font-bold">
          ...
          <div className="w-full flex justify-center items-center">
            <div className="w-28 h-28 p-2 shadow-xl shadow-black transform duration-300 hover:scale-110 ease-in-out">
              <div className="flex justify-center flex-col items-center">
                <img
                  src="https://img.icons8.com/color/96/000000/canva.png"
                  className="w-16 h-16"
                  alt="canva"
                />
                <h5 className="text-center text-white text-lg font-bold">
