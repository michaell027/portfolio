export default function Education() {
  return (
    <div>
      ...
      >
        <div className="flex lg:mt-0 mt-10 mb-10 lg:mb-0 flex-wrap gap-6 md:gap-8 lg:gap-12 items-center justify-center w-full max-w-4xl px-12 sm:px-24 lg:px-0 md:px-44">
          <div className="z-1 flex flex-col flex-grow overflow-hidden transform bg-gray-600/20 rounded-lg shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out w-full md:w-1/2 lg:w-1/4">
            <div className="flex flex-col items-center p-4 md:p-10 bg-gray-400/10">
              <div className="flex items-center py-2">
                <img
                  src="https://kosickaakademia.sk/images/logo.png"
                  alt="logo"
            ...
            <div className="p-4 md:p-10 flex flex-col items-center justify-center">
              <p className="font-semibold text-center text-white pb-6">
          ...
          <div className="z-1 flex flex-col flex-grow overflow-hidden transform bg-gray-600/20 rounded-lg shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out w-full md:w-1/2 lg:w-1/4">
            <div className="flex flex-col items-center p-4 md:p-10 bg-gray-400/10">
              <div className="flex items-center py-2">
                <img
                  src="https://www.gta.sk/images/sablona/gta_logo-2.png"
                  alt="logo"
                  className="w-28 md:w-56"
                />
              </div>
