    ...
    return (
        <div className={`w-auto border-2 border-pink-800 fixed flex ml-4 mt-2 transition-height duration-500 ease-in-out ${menuOpen ? 'h-[50px]' : 'h-[360px]'}`}>
            <ul className="bg-black w-12 rounded-3xl flex flex-col items-center justify-center gap-4 py-4">
                ...
                <li className={`${hideItems ? 'hidden' : ''}`}  onMouseEnter={()=>setHoverHome(true)} onClick={()=>setComponent('home')} onMouseLeave={()=>setHoverHome(false)}>
                ...
                <li className={`${hideItems ? 'hidden' : ''}`} onMouseEnter={()=>setHoverAbout(true)} onClick={()=>setComponent('about')} onMouseLeave={()=>setHoverAbout(false)}>
                ...
                <li className={`${hideItems ? 'hidden' : ''}`} onMouseEnter={()=>setHoverEducation(true)} onClick={()=>setComponent('education')} onMouseLeave={()=>setHoverEducation(false)}>
                    <a className="flex items-center justify-center p-2 rounded-full hover:bg-gray-700 text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                <li className={`${hideItems ? 'hidden' : ''}`}>
                    <a className="flex items-center justify-center p-2 rounded-full hover:bg-gray-700 text-white" onMouseEnter={()=>setHoverSkills(true)} onClick={()=>setComponent('skills')} onMouseLeave={()=>setHoverSkills(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className={`${hideItems ? 'hidden' : ''}`}>
                    <a className="flex items-center justify-center p-2 rounded-full hover:bg-gray-700 text-white" onMouseEnter={()=>setHoverProjects(true)} onClick={()=>setComponent('projects')} onMouseLeave={()=>setHoverProjects(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                ...
                <li className={`${hideItems ? 'hidden' : ''}`}>
                    <a className="flex items-center justify-center p-2 rounded-full hover:bg-gray-700 text-white" onMouseEnter={()=>setHoverContact(true)} onClick={()=>setComponent('contact')} onMouseLeave={()=>setHoverContact(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
