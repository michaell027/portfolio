...
export default function Header() {
    ...
    return (
        <div className={`w-auto fixed flex ml-4 mt-2 transition-height duration-500 ease-in-out ${menuOpen ? 'h-[50px]' : 'h-[360px]'}`}>
            ...
            <ul className="flex flex-col gap-[28px] py-4 pl-2 pt-[65px]">
                ...
                <li className="flex items-center gap-2">
                    <h5 className="text-black">Education</h5>
                </li>
                <li className="flex items-center gap-2">
                    <h5 className="text-black">Skills</h5>
                </li>
                <li className="flex items-center gap-2">
                    <h5 className="text-black">Projects</h5>
                </li>
                <li className="flex items-center gap-2">
