...
export default function Contact() {
  return (
    <>
      <div
        className="font-sans w-full flex items-center justify-center min-h-screen antialiased text-gray-900 loading-normal tracking-wider bg-cover"
        style={{ backgroundImage: "url('header.png')" }}
      >
        <div className="flex flex-col justify-center items-center max-w-full max-h-full">
          <div className="mockup-phone max-w-5xl max-h-full lg:mt-0 my-16 md:mx-20 sm:mx-10 mx-4">
            <div className="camera"></div>
            <div className="display">
              <div className="artboard artboard-demo bg-[#212737] max-w-full pt-10 pb-10">
                <section>
                  <div className="hero bg-[#212737]">
                    <div className="hero-content flex-col lg:flex-row-reverse mx-4 md:mx-8 lg:mx-12 my-4 gap-4 md:gap-8 lg:gap-12">
                      <div className="text-center lg:text-left">
                        <h1 className="text-3xl md:text-4xl lg:text-5xl text-white font-medium">
                          GET{" "}
                          <span className="font-black text-2xl md:text-3xl lg:text-4xl text-[#652f63]">
                            IN TOUCH
                          </span>
                        </h1>
                        <p className="py-4 md:py-6 lg:py-8 text-white">
                          I'm excited to connect with you! Whether you have
                          questions about my work or are interested in working
                          together, don't hesitate to contact me.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center w-full justify-center space-x-4 md:space-x-8 lg:space-x-12">
                          <div className="flex items-center justify-center space-x-4 md:space-x-8 lg:space-x-12">
                            <a
                              href="https://www.instagram.com/_.msk.m._/"
                              target="_blank"
                              rel="noreferrer"
                            >
                              <svg
                            ...
                            <a
                              href="https://www.facebook.com/michaela.miska15"
                              target="_blank"
                              rel="noreferrer"
                            >
                              <svg
